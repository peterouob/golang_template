...
const (
	Video_UploadVideo_FullMethodName = "/Video/UploadVideo"
	Video_GetVideo_FullMethodName    = "/Video/GetVideo"
)
...
func (c *videoClient) UploadVideo(ctx context.Context, in *UploadVideoRequest, opts ...grpc.CallOption) (*UploadVideoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Video_UploadVideo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
